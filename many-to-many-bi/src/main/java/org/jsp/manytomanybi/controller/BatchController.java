...
import org.jsp.manytomanybi.dao.BatchDao;
...
public class BatchController {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println(
					"1). Save Batch data \t 2). Update Batch data \t  3) Find Batch by batch_code");
			System.out.println(
	...
	private static void saveBatchDetails() {
		...
		System.out.println("Batch data saved with id " + batch.getId());
	}
	...
	private static void findBatchByTrainerName() {
		...
		trainer = s.nextLine();
		List<Batch> batches = batchDao.findByTrainerName(trainer);
	...
	private static void findBatchBySubjectName() {

		System.out.println("Enter subject name to get batch details ");
		String subject = s.nextLine();
		List<Batch> batches = batchDao.findBySubject(subject);
	...
	private static void findBatchByStudentId() {

		System.out.println("Enter student id and password to get batch details ");
		int id = s.nextInt();
		String password = s.next();
		List<Batch> batches = batchDao.findByStudentId(id, password);
	...
	private static void findBatchByStudentEmail() {

		System.out.println("Enter student email and password to get batch details ");
		String email = s.next();
		String password = s.next();
		List<Batch> batches = batchDao.findByStudentEmail(email, password);
	...
	private static void findBatchByStudentPhone() {

		System.out.println("Enter student phone and password to get batch details ");
		long phone = s.nextLong();
		String password = s.next();
		List<Batch> batches = batchDao.findByStudentPhone(phone, password);
		...
		if (batches.size() > 0) {
			...
			System.out.println("Invalid Student phone or password");
	}
}
